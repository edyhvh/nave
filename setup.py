...
def main():
    ...
    print("3. Fallback: run `source .venv/bin/activate`")
    print("4. Alternative shell helper: `./scripts/dev_shell.sh`")
    print("5. Use unified CLI: nave --help")
    print("6. Run scripts: python scripts/your_script.py or ./run.sh script_name")
    print("\n📚 Available commands:")
