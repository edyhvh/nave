...
| N5 | experiment/n5-squeeze-discovery | Volatility squeeze as 4th bias source (regime bridge: BB p25 compression → breakout bar → direction → downstream gates) | — (discovery only) | — | ✅ VIABLE — 34 TP / 2 FP (94.4% precision); BB<5% = 0 FP; proposal ready for A/B test | — |
