...
| 15 | experiment/n6-squeeze-daily | daily-cadence squeeze breakout path (off by default) | +50.10 BTC / +52.81 ETH | diagnostic only | ❌ REJECT — BTC FP 26.1% (6/23 resolved), fresh rerun 2026-08-27; snapshot `squeeze_daily_validation_20260827T045812Z.json`; Draft PR remains off | #38 |
