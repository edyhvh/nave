...
def build_llm_prompt(payload: dict) -> str:
    ...
    return "\n".join(
        [
            ...
            "5. Warn explicitly if highest modeled setup has negative EV or Probability of Touch > 85%.",
            "5a. Warn the user if the highest-ranked strategy has negative expected value.",
            "6. Explicitly call out tight condors/spreads when too narrow vs expected move, and mention wider 3-6% OTM bull put spreads when execution quality is better.",
            "Output format:",
